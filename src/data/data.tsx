...
export const dataCardTree = () =>{ 
    ...
    const c1 : CardTree={id:1,questionText:"היכן הבעיה?",answers:[ "אתר","לא"],clicked:40}
    ...
    const c3 : CardTree={id:3,questionText:"האם התחבר בעבר?",answers:[ "לא","כן"] ,clicked:30}
    const c4 : CardTree={id:4,questionText:"שילחו קישור לסיסמא ראשונית. הצליח?",answers:[ "לא","כן"],clicked:32}
    ...
    arrCards[4].nextCards = ([arrCards[7],arrCards[11]])
